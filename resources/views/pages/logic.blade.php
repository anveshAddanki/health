...
for($i=0; $i<2; $i++){ ?>
 <div class="container">
    ...
    <div class="col-md-2" style="background-color: #474B55" >
      <div>
        <button type="submit" style="border:6px solid #529535">Download PDF</button>
      </div>
    </div>       
    </div>
...
<br>
					<div class="col-md-12">
                        <h4>Renwal Plan Options</h4>
                        <p>Up tp twp planes may be selected for renewal. Rates are based on the group's current employees plan tires. The selectedplan(s) will be effective MM/DD/YYYY to MM/DD/YYYY.
                        </p>
                    </div>
<br>
<br>
...
<div class="container">
    <div class="row">
            ...
            <div class="col-md-8">
                <div class="col-md-6">
                    <label class="checkbox-inline"><input type="checkbox" value=""><p>Show with Dentl and Vision</p></label>
					<label class="checkbox-inline"><input type="checkbox" value=""><p>Show with out Dentl and Vision</p></label>
                </div>
...
for($i=0; $i<8; $i++){ ?>
 <div class="container">
    ...
    <div class="col-md-2" style="background-color: #474B55 height: 135px;">
      <div>
